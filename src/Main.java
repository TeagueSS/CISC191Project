 ...
 */
{
	...
	public static void main(String[] args) {
		...
		TrafficYear year2016 = fileImporter.getStreetYearFromFile("ABM2Plus_2021RP_2016_Network_Volumes.csv");
		// "E:\School\JavaProject1_ComparingStreetTrafficData\src\ABM2Plus_2021RP_2016_Network_Volumes.csv"
		TrafficYear year2025 = fileImporter.getStreetYearFromFile("ABM2Plus_2021RP_2025_Network_Volumes.csv");

		TrafficYear year2035 = fileImporter.getStreetYearFromFile("ABM2Plus_2021RP_2035_Network_Volumes.csv");

		TrafficYear year2050 = fileImporter.getStreetYearFromFile("ABM2Plus_2021RP_2050_Network_Volumes.csv");
		...
		// Creating a pannel to hold our title as well as our search bar
		...
		JTextArea mainTextBox = new JTextArea("Welcome to traffic street view, search for a street to get started \n "
		...
		streetSearchPanel.setBorder(
				BorderFactory.createTitledBorder(BorderFactory.createRaisedSoftBevelBorder(), "Input Search Criteria"));
		...
		// standard practice panel settings (format, set visible to user, close operation)
